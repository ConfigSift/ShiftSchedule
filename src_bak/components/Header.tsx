  ...
  return (
    <header className="h-16 bg-theme-secondary border-b border-theme-primary flex items-center justify-between px-6 shrink-0 transition-theme">
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-theme-tertiary text-theme-secondary hover:bg-theme-hover hover:text-theme-primary transition-colors text-sm font-medium">
          <UserPlus className="w-4 h-4" />
          Add Staff
        </button>
        <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-amber-500 text-zinc-900 hover:bg-amber-400 transition-colors text-sm font-medium">
